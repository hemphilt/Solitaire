...
public class Logic {
    ...
    public static String howToPlay() {
        return "The four aces form the foundations. As it becomes available, each ace must be played to a row above " +
                "the piles. " +
                "\nCards in the appropriate suit are then played on the aces in sequence - the two, then the three, " +
                ...
                "\nExample: A black five may be played on a red six. If more than one card is face up on a tableau " +
                "pile, " +
                "\nall such cards must be moved as a unit.\n" +
                "\n" +
                "When there is no face-up card left on a pile, the top face-down card is turned up and becomes " +
                "available.\n" +
                "\n" +
                ...
                "\nbuilding on the piles, if possible, played on a foundation. If a card is used in this manner, " +
                "the card below it becomes available for play. " +
                "\nIf the up-card cannot be used, the one, two, or three cards of the group are placed face up on the " +

...
public class Logic {
    ...
    public static String howToPlay() {
        return "The four aces form the foundations. As it becomes available, "
                +
                "each ace must be played to a row above the piles. "
                +
                "\nCards in the appropriate suit are then "
                +
                "played on the aces in sequence - "
                +
                "the two, then the three, and so on - as "
                +
                "they become available.\n"
                +
                "\n"
                +
                "Any movable card may be placed on a card "
                +
                "next-higher in rank if it is of opposite color. "
                +
                "\nExample: A black five may be played on a red six. "
                +
                "If more than one card is face up on a tableau pile, "
                +
                "\nall such cards must be moved as a unit.\n"
                +
                "\n"
                +
                "When there is no face-up card left "
                +
                "on a pile, the top face-down "
                +
                ...
                +
                "The player turns up cards from the "
                +
                "\ntop of the stock in groups of three, "
                +
                "and the top card of the "
                +
                "three may be used for "
                +
                "\nbuilding on the piles, if possible, "
                +
                "played on a foundation. "
                +
                "If a card is used in this manner, the "
                +
                "card below it becomes available for play. "
                +
                "\nIf the up-card cannot be used, "
                +
                "the one, two, or three cards of the "
                +
                "group are placed face up on the waste pile, "
                +
                "and the next group of three cards is turned up.";
    }
    ...
    public static String controls() {
        return "First, click on the card/pile that you want to move."
                +
                "\nIf you want to move the entire pile, "
                +
                "use the LEFT CLICK button to select it."
                +
                "\nIf the card that you want to move is the "
                +
                "last card in the pile, use the "
                +
                "RIGHT CLICK button to select it."
                +
                "\nThen, click on the pile that "
                +
                "you want to move it to.\n"
                +
                "\nNOTE: If the card/piles are not moving, "
                +
                "try clicking on the same card twice to reset the selections.";
    }
     ...
     * It checks if all the cards in
     * the deck and discard/draw are empty.
     * Then counts the number of shown cards in the remaining piles.
     *
     ...
     * @param whichCard which card is selected
     * @return int      the int returns is based on where the pile is moved from
     */
    public static int movePile(final Pile give,
                               final Pile take,
                               final int whichCard) {
     ...
     */
    public static void changeBackImage(final BufferedImage img) {
        if (deck != null) {

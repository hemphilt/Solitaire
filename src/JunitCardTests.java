...
public class JunitCardTests {
    ...
    /*************************************************************************
     * This tests if the front image of the card is set correctly by testing
     * the getCardURL() function in the Card class
     *****************************************************************/
    @Test
    public void testCardGetCardURL() {
        card = new Card(Suit.HEARTS, Rank.KING);
        assertEquals(card.getCardURL(), "/images/KING HEARTS.png");
    }
}
